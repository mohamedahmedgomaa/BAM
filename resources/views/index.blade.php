                        ...
                        <div class="p_icon">
                            ...
                            @else
                                ...
                                @foreach ($first_post->likes as $like)
                                    ...
                                    @endphp
                                @endforeach
                                <button type="button" data-productid="{{ $first_post->id }}_l"
                        ...
                        <div class="p_icon">
                            ...
                            @else
                                ...
                                @foreach ($second_post->likes as $like)
                                    ...
                                    @endphp
                                @endforeach
                                <button type="button" data-productid="{{ $second_post->id }}_l"
                                        data-like="{{ $like_status }}"
                                        class="ti-heart like btn {{ $like_status }}" style="">
                                    <i aria-hidden="true"></i>
                                </button>
                        ...
                        <div class="p_icon">
                            ...
                            @else
                                ...
                                @foreach ($third_post->likes as $like)
                                    ...
                                    @endphp
                                @endforeach
                                <button type="button" data-productid="{{ $third_post->id }}_l"
                                        data-like="{{ $like_status }}"
                                        class="ti-heart like btn {{ $like_status }}" style="">
                                    <i aria-hidden="true"></i>
                                </button>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="new_product">
                    ...
                    <a href="{{ route('product.addToCart', ['id' => $four_post->id]) }}" class="main_btn">Add To
                        Shopping Cart</a>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-product">
                                ...
                                <div class="p_icon">
                                    ...
                                    @else
                                        ...
                                        @foreach ($five_post->likes as $like)
                                            ...
                                            @endphp
                                        @endforeach
                                        <button type="button" data-productid="{{ $five_post->id }}_l"
                                                data-like="{{ $like_status }}"
                                                class="ti-heart like btn {{ $like_status }}" style="">
                                            <i aria-hidden="true"></i>
                                        </button>
                            ...
                            <div class="product-btm">
                                ...
                                <a href="{{ route('category.show', ['id' => $five_post->category->id]) }}"
                                   class="d-block">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-product">
                                ...
                                <div class="p_icon">
                                    ...
                                    @else
                                        ...
                                        @foreach ($sex_post->likes as $like)
                                            ...
                                            @endphp
                                        @endforeach
                                        <button type="button" data-productid="{{ $sex_post->id }}_l"
                                                data-like="{{ $like_status }}"
                                                class="ti-heart like btn {{ $like_status }}" style="">
                                            <i aria-hidden="true"></i>
                                        </button>
                            ...
                            <div class="product-btm">
                                ...
                                <a href="{{ route('category.show', ['id' => $sex_post->category->id]) }}"
                                   class="d-block">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-product">
                                ...
                                <div class="p_icon">
                                    ...
                                    @else
                                        ...
                                        @foreach ($seven_post->likes as $like)
                                            ...
                                            @endphp
                                        @endforeach
                                        <button type="button" data-productid="{{ $seven_post->id }}_l"
                                                data-like="{{ $like_status }}"
                                                class="ti-heart like btn {{ $like_status }}" style="">
                                            <i aria-hidden="true"></i>
                                        </button>
                            ...
                            <div class="product-btm">
                                ...
                                <a href="{{ route('category.show', ['id' => $seven_post->category->id]) }}"
                                   class="d-block">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="single-product">
                                ...
                                <div class="p_icon">
                                    ...
                                    @else
                                        ...
                                        @foreach ($eight_post->likes as $like)
                                            ...
                                            @endphp
                                        @endforeach
                                        <button type="button" data-productid="{{ $eight_post->id }}_l"
                                                data-like="{{ $like_status }}"
                                                class="ti-heart like btn {{ $like_status }}" style="">
                                            <i aria-hidden="true"></i>
                                        </button>
                            ...
                            <div class="product-btm">
                                ...
                                <a href="{{ route('category.show', ['id' => $eight_post->category->id]) }}"
                                   class="d-block">
...
<section class="inspired_product_area section_gap_bottom_custom">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="main_title">
                    <a href="{{ route('category.show', ['id' => $category1->id]) }}"><h2>
                            <span>{{ $category1->name }}</span></h2></a>
                            ...
                            <div class="p_icon">
                                ...
                                @else
                                    ...
                                    @foreach ($product->likes as $like)
                                        ...
                                        @endphp
                                    @endforeach
                                    <button type="button" data-productid="{{ $product->id }}_l"
                                            data-like="{{ $like_status }}"
                                            class="ti-heart like btn {{ $like_status }}" style="">
                                        <i aria-hidden="true"></i>
                                    </button>
...
<section class="inspired_product_area section_gap_bottom_custom">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="main_title">
                    <a href="{{ route('category.show', ['id' => $category2->id]) }}"><h2>
                            <span>{{ $category2->name }}</span></h2></a>
                    <p>Bring called seed first of third give itself now ment</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="p_icon">
                                ...
                                @else
                                    ...
                                    @foreach ($product2->likes as $like)
                                        ...
                                        @endphp
                                    @endforeach
                                    <button type="button" data-productid="{{ $product2->id }}_l"
                                            data-like="{{ $like_status }}"
                                            class="ti-heart like btn {{ $like_status }}" style="">
                                        <i aria-hidden="true"></i>
                                    </button>
...
<section class="inspired_product_area section_gap_bottom_custom">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="main_title">
                    <a href="{{ route('category.show', ['id' => $category3->id]) }}"><h2>
                            <span>{{ $category3->name }}</span></h2></a>
                    <p>Bring called seed first of third give itself now ment</p>
                </div>
            </div>
        </div>
                            ...
                            <div class="p_icon">
                                ...
                                @else
                                    ...
                                    @foreach ($product3->likes as $like)
                                        ...
                                        @endphp
                                    @endforeach
                                    <button type="button" data-productid="{{ $product3->id }}_l"
                                            data-like="{{ $like_status }}"
                                            class="ti-heart like btn {{ $like_status }}" style="">
                                        <i aria-hidden="true"></i>
                                    </button>
