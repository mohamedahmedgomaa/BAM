...
<div class="register-box">
  <div class="register-logo">
    <a href="{{ url('design/adminlte') }}/index2.html"><b>BA</b>M</a>
  </div>
  ...
  <div class="register-box-body">
    ...
    <form action="/register" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" value="{{ old('name') }}" placeholder="Full name">
      ...
      {{-- <div class="form-group has-feedback">
        <input type="select" class="form-control" value="{{ old('level') }}" placeholder="Level">
